...
export const DEFAULT_CONFIG: PluginConfig = {
    ...
    listenHost: '0.0.0.0',
    listenPort: 3002,
    adapterTypes: ['napcat', 'snowluma', 'generic-ob11'],
...
export const CONFIG_SCHEMA = {
    ...
    properties: {
        ...
        customForwardInfo: { type: 'boolean', default: false, description: '自定义合并转发信息' },
        customForwardQQ: { type: 'string', default: '', description: '自定义合并转发 QQ 号' },
        customForwardName: { type: 'string', default: '', description: '自定义合并转发昵称' },
        ...
        adapterTypes: { type: 'array', default: ['napcat', 'snowluma', 'generic-ob11'], description: '启用的协议适配器类型列表' },
